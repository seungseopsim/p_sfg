...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  {
    iframes = document.getElementsByClassName("iframe100");

    if (null != iframes) {
      for (idx = 0; idx < iframes.length; ++idx) {
        iframe = iframes[idx].contentWindow;

        doc = iframe.document.onclick = function () {
          alert("bbbb");
        };

        iframes[idx].click(function () {
          alert("AAA");
        });
      }
    }
...
/******/ });
//# sourceMappingURL=reportrooms-ab18bdfe61422b425113.js.map