  ...
  }, 3000);
  {
    ...
    if (null != iframes) {
      for (idx = 0; idx < iframes.length; ++idx) {
        iframes[idx].onclick = function () {
          alert("AAA");
        };
      }
    }

    iframe = document.getElementById("ds");

    if (null != iframe) {
      iframe.bind('click', function (_clickevent) {
        alert("ADSFASDF");
      });
    }
  }
...
/******/ });
//# sourceMappingURL=reportrooms-5ff045ec541962b38720.js.map