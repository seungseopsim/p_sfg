...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  iframeOnClick = function iframeOnClick() {
    ...
    for (idx = 0; idx < iframese.length; ++idx) {
      iframese[idx].onclick = function () {
        alert("AAA");
      };
    }
  };
...
/******/ });
//# sourceMappingURL=reportrooms-8cd39ebac852b2c47738.js.map