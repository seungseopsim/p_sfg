...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  TextareaKeydown = function TextareaKeydown(event) {
    if (event.keyCode == 9) {
      ...
      var select = event.selectionStart;
      alert(event.target.name); // this.value = this.value.substring(0,this.selectionStart) + "\t" + this.value.substring(this.selectionEnd);
...
/******/ });
//# sourceMappingURL=reportrooms-c9c105129425dc11e135.js.map