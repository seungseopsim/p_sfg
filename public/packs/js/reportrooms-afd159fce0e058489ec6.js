...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  TextareaKeydown = function TextareaKeydown(event) {
    if (event.keyCode == 9) {
      ...
      alert(select); // this.value = this.value.substring(0,this.selectionStart) + "\t" + this.value.substring(this.selectionEnd);
...
/******/ });
//# sourceMappingURL=reportrooms-afd159fce0e058489ec6.js.map