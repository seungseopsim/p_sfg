  ...
  }, 3000);
  {
    ...
    if (null != buttons) {
      for (idx = 0; idx < buttons.length; ++idx) {
        buttons[idx].onclick = function (_cevent) {
          buttons[idx].addEventListener('show.bs.collapse', function (_dad) {
            alert("ASDFASF");
          });
        };
      }
...
/******/ });
//# sourceMappingURL=reportrooms-c61cb1c54aa33c823f5d.js.map