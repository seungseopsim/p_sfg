  ...
  }, 3000);
  {
    ...
    if (null != buttons) {
      for (idx = 0; idx < buttons.length; ++idx) {
        ...
        var frame = document.getElementById(targetid.replace("#", ""));

        if (null != frame) {
          frame.addEventListener('shown.bs.collapse', function () {
            alert("ASDFAS");
          });
...
/******/ });
//# sourceMappingURL=reportrooms-a52047b9ac54308cbddc.js.map