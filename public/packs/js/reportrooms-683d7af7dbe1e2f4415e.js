...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  TextareaKeydown = function TextareaKeydown(event) {
    if (event.keyCode == 9) {
      ...
      alert(event.target); // this.value = this.value.substring(0,this.selectionStart) + "\t" + this.value.substring(this.selectionEnd);
...
/******/ });
//# sourceMappingURL=reportrooms-683d7af7dbe1e2f4415e.js.map