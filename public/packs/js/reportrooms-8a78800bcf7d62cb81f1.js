...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  TextareaKeydown = function TextareaKeydown(event) {
    if (event.keyCode == 9) {
      ...
      alert(event.target.id); // this.value = this.value.substring(0,this.selectionStart) + "\t" + this.value.substring(this.selectionEnd);
...
/******/ });
//# sourceMappingURL=reportrooms-8a78800bcf7d62cb81f1.js.map