        ...
        $(buttons[idx].dataset.target).one('shown.bs.collapse', function (e) {
          ...
          if (null != obj) {
            ...
            if (null != targetid) {
              ...
              path = "/reportrooms/read"; //document.location.href = path;
              ...
              httpRequest.send("/reportrooms/read?id=".concat(id));
            }
          }
        });
      }
...
/******/ });
//# sourceMappingURL=reportrooms-949d457f9dbf76cab880.js.map