...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  {
    var buttons = document.getElementsByClassName("btn collapsed");
    ...
    if (null != buttons) {
      for (idx = 0; idx < buttons.length; ++idx) {
        ...
        if (null != frame) {
          frame.addEventListener('show.bs.collapse', function () {
            alert("ASDFAS");
          });
...
/******/ });
//# sourceMappingURL=reportrooms-36fa5494e2d2fd4e2619.js.map