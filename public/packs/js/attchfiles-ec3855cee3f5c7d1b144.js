  ...
  SelectFiles = function showSelectFiles(_event) {
    ...
    try {
      ...
      for (i = 0; i < filesCnt; i++) {
        ...
        filelistTag += "<div><li>" + filelist[i].name + "</li>";
      }
      ...
      if (null != filelistElemnet) {
        ...
        filelistElemnet.innerHTML += "<button class='button-delete-file'>삭제</button></div>";
      }
    } catch (_e) {
      console.log(_e);
    }
...
/******/ });
//# sourceMappingURL=attchfiles-ec3855cee3f5c7d1b144.js.map