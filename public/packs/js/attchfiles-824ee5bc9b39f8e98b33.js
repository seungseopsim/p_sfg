...
document.addEventListener("DOMContentLoaded", function (event) {
  SelectFiles = function showSelectFiles(_event) {
    ...
    try {
      /*
      var selectfileElemnet = document.getElementById("reportroom_attachment");
  ...
  Vaildform = function Vaildform() {
    selectobj = document.getAnimations('reportroom_type');
    alert(selectobj.selectIndex);
    return false;
  };
});
...
/******/ });
//# sourceMappingURL=attchfiles-824ee5bc9b39f8e98b33.js.map