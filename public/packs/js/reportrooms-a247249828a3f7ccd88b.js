        ...
        $(buttons[idx].dataset.target).one('shown.bs.collapse', function (e) {
          ...
          if (null != obj) {
            ...
            if (null != targetid) {
              ...
              param = "id=".concat(id); //document.location.href = path;
              ...
              httpRequest.onreadystatechange = function () {
                if (this.readyState == this.DONE) {//console.log(this.status);
...
/******/ });
//# sourceMappingURL=reportrooms-a247249828a3f7ccd88b.js.map